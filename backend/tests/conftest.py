...
def player_advanced_stat_row():
    return {
        ...
        "season_id": 20252026,
        "games_played": 50,
        "icetime_seconds": 45200,
        "corsi_for_pct": 0.574,
        "fenwick_for_pct": 0.5582,
        "xgoals_for_pct": 0.552,
        "xgoals_for": 38.42,
        "xgoals_against": 31.18,
        "individual_xgoals": 12.63,
        "pdo": 101.4,
...
@pytest.fixture
def player_career_totals_skater_row():
    return {
        "id": 57,
        "player_id": 8477492,
        ...
        "pim": 428,
        "shots": 3842,
        "shooting_pctg": 0.1093,
        "power_play_goals": 113,
        "power_play_points": 356,
        "shorthanded_goals": 2,
        "shorthanded_points": 4,
        "game_winning_goals": 76,
        "ot_goals": 15,
        "wins": None,
        "losses": None,
        "ot_losses": None,
...
@pytest.fixture
def player_career_totals_skater_playoffs_row(player_career_totals_skater_row):
    return dict(
        ...
        pim=52,
        shots=410,
        shooting_pctg=0.1171,
        power_play_goals=14,
        power_play_points=38,
        shorthanded_goals=0,
        shorthanded_points=1,
...
@pytest.fixture
def player_career_totals_goalie_row():
    return {
        "id": 91,
        "player_id": 8475809,
        "season_type": "regular_season",
